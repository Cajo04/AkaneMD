...
const API_KEY     = process.env.OPENROUTER_API_KEY ||"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";
...
app.listen(PORT, () => console.log(`Akane MD running on port ${PORT}`));
